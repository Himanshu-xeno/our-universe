...
//         ctx.fillText(col.label, col.x - 15, col.y + 35);
//       });
...
//         ctx.strokeRect(-obs.width / 2, -obs.height / 2, obs.width, obs.height);
//         ctx.fillStyle = "white";
//         ctx.font = "bold 16px sans-serif"; // BIGGER FONT
//         ctx.textAlign = "center";
//         ctx.textBaseline = "middle";
//         ctx.fillText(obs.label, 0, 0);
//         ctx.restore();
...
//   // UseEffect for events (kept same as before, simplified for brevity here, but ensure your existing event listeners are here)
//   useEffect(() => {
//     const canvas = canvasRef.current;
//     if (!canvas) return;
//     const resize = () => {
