...
// import { useAppStore, StarData } from "@/store/useAppStore";
// import { useProgress } from "@/hooks/useProgress";
// import { useRefreshRedirect } from "@/hooks/useRefreshRedirect"; // <--- ADDED IMPORT
// import GlowButton from "@/components/ui/GlowButton";
// import AudioPlayer from "@/components/ui/AudioPlayer";
// import BackButton from "@/components/ui/BackButton";
// import { STARS_DATA } from "@/utils/constants";
...
//   // 1. Handle Refresh Logic
//   useRefreshRedirect(); // <--- ADDED HOOK CALL

//   const _hasHydrated = useAppStore((s) => s._hasHydrated); // <--- CHECK HYDRATION
//   const visitedStars = useAppStore((s) => s.visitedStars);
//   const visitStar = useAppStore((s) => s.visitStar);
//   const unlockReveal = useAppStore((s) => s.unlockReveal);
...
//   // 2. Prevent render until hydrated to avoid mismatch
